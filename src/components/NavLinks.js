...
const NavLinks = () => {
    ...
    return (
        <nav className="flex flex-col sm:p-4">
            
            <LanguageSwitcher resolveLanguageName={(locale) => intl.formatMessage({ id: `${locale}` })} className="mb-4 mx-4 sm:mx-0  underline hover:text-neutral-400 self-end"/>
