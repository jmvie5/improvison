  ...
  return (
    <Layout pageTitle="Pour en savoir plus">
		...
		<div className="flex flex-col gap-2 ml-4 pb-8">
			<a href="https://tonic-music.myshopify.com/" className="italic text-xl">Tonic. The Music Improvisation Card Game</a>
			<ul className="ml-6">
		...
		<div>
			<h1 className="font-bold text-xl">Références théoriques et scientigiques</h1>
