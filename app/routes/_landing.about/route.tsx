  ...
  return (
    <div className="">
      ...
      <div className="flex flex-col xs:inline">
        <h2 className="font-semi-bold text-2xl pb-6">
          {translations.principalInvestigator}
        </h2>
        ...
        <p className="font-light">
          ...
          <span>{translations.piText1}</span>
          <span className="italic">{translations.piTextJournals1}</span>
          <span>{translations.andThe}</span>
          <span className="italic">{translations.piTextJournals2}</span>
          <span>{translations.piText2}</span>
        </p>

        <h2 className="font-semi-bold text-2xl pt-16 pb-6">
          {translations.gameIdeation}
        </h2>
