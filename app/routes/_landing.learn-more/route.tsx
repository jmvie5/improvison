    ...
    <div className="flex flex-col pb-4 font-light gap-4">
      ...
      <div className="break-words inline">
        ...
        <ul className="gap-2 pl-4">
          ...
          <li className="-indent-4 break-words ">
            Després, J.-P. (2017b). Processus d’apprentissage et de création des
          ...
          <li className="-indent-4 break-words ">
            Després, J.-P., Burnard, P., Dubé, F. et Stévance, S. (2016). Expert
          ...
          <li className="-indent-4 break-words ">
            Després, J.-P., Burnard, P., Dubé, F. et Stévance, S. (2017). Expert
          ...
          <li className="-indent-4 break-words ">
            Kratus, J. (1995). A Developmental Approach to Teaching Music
