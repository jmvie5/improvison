...
export default function Level() {
  ...
  const [currentSubLvl, setCurrentSubLvl] = useState(
    currentLvl.intro as SubLvlInterface
  );
  const subLevelRef = useRef<{
    removeAudio: () => void;
    saveAudioToProfile: (remove: boolean) => Promise<void>;
  }>();
      ...
      <div className="h-full flex flex-col grow justify-between">
        ...
        >
          <ModalContent>
            ...
            <ModalBody>{translations.noAudioRecorded}</ModalBody>
            <ModalFooter>
              <Button
                color="success"
                onPress={() => {
        ...
        <SubLvl
          ...
          ref={subLevelRef}
        />
        <footer className="flex  shadow-lg-rev  justify-between p-4 bg-primary-900">
          <div className="flex gap-2 self-center">
            <Button as={Link} to={"/solo/game"}>
