  ...
  intro: {
    ...
    description: (transposition?: string) => (
      <div className="inline gap-2">
        <p>{t("pages.soloGameLevels.targetNotes.intro.subTitle")}</p>
        <p className="italic p-4">
          {t("pages.soloGameLevels.targetNotes.intro.important")}
        </p>
        <p>{t("pages.soloGameLevels.targetNotes.intro.desc")}</p>
        <p>{t("pages.soloGameLevels.targetNotes.intro.instruction")}</p>
        <SheetMusic
        ...
        <iframe
          ...
          src="https://www.youtube.com/embed/JpC5hXefoV4"
          title="Bb backing track"
        />
      </div>
    ),
    ...
    description: (transposition?: string) => (
      <div className="">
        ...
        <ol className=" list-inside list-disc">
          <li>
            {t("pages.soloGameLevels.targetNotes.freeImprov.instruction1")}
          </li>
          <li>
            {t("pages.soloGameLevels.targetNotes.freeImprov.instruction2")}
          </li>
          <li>
            {t("pages.soloGameLevels.targetNotes.freeImprov.instruction3")}
          </li>
          <li>
            {t("pages.soloGameLevels.targetNotes.freeImprov.instruction4")}
          </li>
          <li>
            {t("pages.soloGameLevels.targetNotes.freeImprov.instruction5")}
          </li>
          <li>
            {t("pages.soloGameLevels.targetNotes.freeImprov.instruction6")}
          </li>
        </ol>
        <p>{t("pages.soloGameLevels.targetNotes.freeImprov.metronome")}</p>
        <p className="font-bold pt-4">
          {t(
            "pages.soloGameLevels.targetNotes.freeImprov.lackingInspiration.title"
          )}
        </p>
        <p>
          {t(
            "pages.soloGameLevels.targetNotes.freeImprov.lackingInspiration.desc"
          )}
        </p>
  ...
  repertoireImprov: {
    ...
    description: (transposition?: string) => (
      <div className="">
        ...
        <p>
          <p>{t("pages.soloGameLevels.targetNotes.repertoireImprov.record")}</p>
        </p>
      </div>
    ),
    vfProps: {
