    ...
    description: (transposition?: string) => (
      <div className="inline gap-2">
        ...
        <div className="my-4 font-medium">
          <p>{t("pages.soloGameLevels.motifs.intro.instructionDesc")}</p>
          ...
          <p>{t("pages.soloGameLevels.motifs.intro.instructionFinal")}</p>
        </div>
        <p>{t("pages.soloGameLevels.motifs.intro.final")}</p>
        <p className="mt-8">
          {t("pages.soloGameLevels.motifs.intro.examples")}
        </p>
        <iframe
          className="w-full aspect-video max-w-[800px]"
          src="https://www.youtube.com/embed/drHkTvXqMHI?si=bIprN8MeX8miNqQG&amp;controls=2&amp;start=125&end=135"
  ...
  repertoireImprov: {
    ...
    description: (transposition?: string) => (
      <div className="inline gap-2">
        ...
        <div className="my-4 font-medium">
          <p>{t("pages.soloGameLevels.motifs.repertoireImprov.goal")}</p>
        </div>
        <p>{t("pages.soloGameLevels.motifs.repertoireImprov.record")}</p>
      </div>
    ),
    vfProps: {
      template: mrPC,
