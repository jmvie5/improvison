    ...
    description: (transposition?: string) => (
      <div className="inline gap-2">
        <div className="my-4">
          ...
          <ol className=" list-inside list-disc">
            <li>
              {t("pages.soloGameLevels.minorScale.freeImprov.instruction1")}
            </li>
            <li>
              {t("pages.soloGameLevels.minorScale.freeImprov.instruction2")}
            </li>
            <li>
              {t("pages.soloGameLevels.minorScale.freeImprov.instruction3")}
            </li>
            <li>
              {t("pages.soloGameLevels.minorScale.freeImprov.instruction4")}
            </li>
            <li>
              {t("pages.soloGameLevels.minorScale.freeImprov.instruction5")}
            </li>
            <li>
              {t("pages.soloGameLevels.minorScale.freeImprov.instruction6")}
            </li>
          </ol>
        </div>
        <p>{t("pages.soloGameLevels.minorScale.freeImprov.metronome")}</p>

        <p className="font-bold pt-4">
          {t(
            "pages.soloGameLevels.minorScale.freeImprov.lackingInspiration.title"
          )}
        </p>
        <p>
          {t(
            "pages.soloGameLevels.minorScale.freeImprov.lackingInspiration.desc"
          )}
        </p>
      </div>
    ),
    ...
    description: (transposition?: string) => (
      <div className="inline gap-2">
        ...
        <iframe
          ...
          src="https://www.youtube.com/embed/2uo_Xmi-mdU?si=d0P4axFKTSlbAJTH"
          title="Piste d'accompagnement Mr.P.C."
          allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
          referrerPolicy="strict-origin-when-cross-origin"
        ></iframe>

        <p>{t("pages.soloGameLevels.minorScale.repertoireImprov.record")}</p>
      </div>
    ),
    vfProps: {
      template: mrPC,
