  ...
  intro: {
    ...
    description: (transposition?: string) => (
      <div className="inline gap-2">
        ...
        <p className=" italic">
          {t("pages.soloGameLevels.pentaMin.intro.notTooFast")}
        </p>
        <p className="mt-8">
          {t("pages.soloGameLevels.pentaMin.intro.examples")}
        </p>
        <iframe
          className="w-full aspect-video max-w-[800px]"
          src="https://www.youtube.com/embed/AKyOg3mNDUs?si=beadOS0j0pqpQPpG&amp;controls=2&amp;start=113&end=122"
