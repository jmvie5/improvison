  ...
  return (
    <div>
      ...
      <div className="flex flex-col xl:flex-row gap-4 justify-center items-center mb-4 flex-1">
        <Card
          className="bg-bleu-pale/20 h-full w-fit max-w-80 aspect-square xl:w-1/3 p-4 text-white border border-neutral-500 shadow-md shadow-black"
          as={Link}
        ...
        >
          <CardHeader className="justify-center">
            <p className="font-bold text-xl">
              {t("pages.landingDuo.playOnlineCard.title")}
            </p>
          </CardHeader>
        ...
        <Card
          ...
          as={Link}
          href="app/static/files/Improvison_Règles numériques.pdf"
          target="_blank"
          rel="noreferrer"
        >
          <CardHeader className="justify-center">
            <p className="font-bold text-xl">
              {t("pages.landingDuo.rulesCard.title")}
            </p>
          </CardHeader>
          <CardBody className="items-center">
        ...
        >
          <CardHeader className="justify-center">
            <p className="font-bold text-xl">
              {t("pages.landingDuo.boardGameCard.title")}
            </p>
          </CardHeader>
          <CardBody className="items-center">
