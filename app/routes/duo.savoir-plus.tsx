	...
	return (
        ...
        <div className="grid grid-cols-1 justify-center mb-4">
            ...
            <div className="flex flex-col gap-2 ml-4 pb-8">
                ...
                <Link to={Stratégies_d_improvisation_2022} className="underline text-xl hover:text-neutral-400" aria-label="Stratégies d'improvisations (PDF)">Stratégies d'improvisations (PDF)</Link>
                <ul className="ml-6 mb-2 list-disc"> 
                    <li>Liste de stratégie d’improvisation développée par Jean-Philippe Després.</li>
                </ul>
            </div>
